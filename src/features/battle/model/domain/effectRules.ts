...
const effectTemplates: Record<string, EffectTemplate> = {
  ...
  "add-attack-per-opponent-energy": {
    label: "{amount:+} атаки за энергию соперника",
    timing: "attack",
    stat: "attack",
    target: "self",
  ...
  "add-attack-per-opponent-hp": {
    label: "{amount:+} атаки за жизнь соперника",
    timing: "attack",
    stat: "attack",
    target: "self",
  ...
  "add-attack-to-clan-hand": {
    label: "{amount:+} атаки клану",
    timing: "attack",
    stat: "attack",
    target: "self",
  },
  "add-power-to-clan-hand": {
    label: "{amount:+} силы клану",
    timing: "before_attack",
    stat: "power",
    target: "self",
  },
  "apply-blessing": {
    label: "благословение {amount:+}",
    timing: "after_damage",
    stat: "status",
    target: "self",
    outcome: "on_win",
